...
@ExportScenarios
@IgnoreOnCIMainBuild
Функционал: Загрузка клиентов

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

@ТипШага: Загрузка данных
@Описание: Экспорт клиентов
@ПримерИспользования: И загружаем клиентов

Сценарий: загружаем клиентов
